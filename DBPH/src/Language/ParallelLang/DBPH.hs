module Language.ParallelLang.DBPH (nkl2SQL, nkl2Alg, nkl2fkl, Query(..), Layout(..), SQL(..), Schema, nkl2X100Alg, X100(..), nkl2X100File, nkl2Dot) where
...
nkl2Dot :: NKL.Expr -> String
nkl2Dot e = toVecDot $ runTransform $ flatTransform e                  
