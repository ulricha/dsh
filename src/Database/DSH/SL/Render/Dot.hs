...
opDotLabel i (UnOp (Fold a) _) = renderLabelArg i "fold" (pretty a)
...
opDotLabel i (BinOp (UnboxDefault e) _ _) = renderLabelArg i "unboxdefault" (pretty e)
...
opDotLabel i (BinOp MergeSeg _ _) = renderLabel i "mergeseg"
...
opDotColor (BinOp (UnboxDefault _) _ _) = DCTan
