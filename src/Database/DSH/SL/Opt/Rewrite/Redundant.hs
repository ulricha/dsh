...
distLiftProjectLeft :: SLRule BottomUpProps
...
distLiftProjectRight :: SLRule BottomUpProps
...
distLiftStacked :: SLRule BottomUpProps
distLiftStacked q =
...
-- input.
alignedDistRight :: SLRule BottomUpProps
alignedDistRight q =
...
-- change the shape of the vector, only adds columns from its right
-- input.
alignedDistLeft :: SLRule BottomUpProps
alignedDistLeft q =
...
-- same.
sameInputAlign :: SLRule BottomUpProps
sameInputAlign q =
...
alignProjectLeft :: SLRule BottomUpProps
alignProjectLeft q =
...
alignProjectRight :: SLRule BottomUpProps
alignProjectRight q =
...
alignWinRight :: SLRule BottomUpProps
alignWinRight q =
...
alignWinLeft :: SLRule BottomUpProps
alignWinLeft q =
...
alignWinRightPush :: SLRule BottomUpProps
alignWinRightPush q =
...
alignGroupJoinRight :: SLRule BottomUpProps
...
alignGroupJoinLeft :: SLRule BottomUpProps
...
-- both inputs.
alignUnboxSngRight :: SLRule BottomUpProps
...
alignUnboxSngLeft :: SLRule BottomUpProps
alignUnboxSngLeft q =
...
pullProjectGroupJoinLeft :: SLRule BottomUpProps
...
pullProjectGroupJoinRight :: SLRule BottomUpProps
...
pullProjectReplicateVecLeft :: SLRule BottomUpProps
...
pullProjectReplicateVecRight :: SLRule BottomUpProps
...
pullProjectUnboxSngLeft :: SLRule BottomUpProps
...
pullProjectUnboxSngRight :: SLRule BottomUpProps
...
pullProjectReplicateScalarRight :: SLRule BottomUpProps
