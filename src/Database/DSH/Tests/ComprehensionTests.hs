...
tests_comprehensions :: (Backend b, VectorLang v) => DSHTestTree v b
...
tests_lifted_joins :: (Backend b, VectorLang v) => DSHTestTree v b
...
tests_join_hunit :: (Backend b, VectorLang v) => DSHTestTree v b
...
tests_nest_head_hunit :: (Backend b, VectorLang v) => DSHTestTree v b
...
tests_nest_guard_hunit :: (Backend b, VectorLang v) => DSHTestTree v b
...
prop_thetajoin_eq :: (Backend b, VectorLang v) => ([(Integer, Integer)], [(Integer, Integer)]) -> DSHProperty v b
...
prop_thetajoin_neq :: (Backend b, VectorLang v) => ([(Integer, Integer)], [(Integer, Integer)]) -> DSHProperty v b
...
prop_eqjoin3 :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
prop_eqjoin3 = makePropEq C.eqjoin3 eqjoin3_native
  where
    eqjoin3_native (xs, ys, zs) = [ (x, y, z) | x <- xs , y <- ys , z <- zs , x == y , y == z]

prop_eqjoin_nested_left :: (Backend b, VectorLang v) => ([(Integer, [Integer])], [Integer]) -> DSHProperty v b
...
prop_eqjoin_nested_right :: (Backend b, VectorLang v) => ([Integer], [(Integer, [Integer])]) -> DSHProperty v b
...
prop_eqjoin_nested_both :: (Backend b, VectorLang v) => ([(Integer, [Integer])], [(Integer, [Integer])]) -> DSHProperty v b
...
prop_nestjoin :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_nestjoin = makePropEq C.nestjoin nestjoin_native
  where
    nestjoin_native (xs, ys) = [ (x, [ y | y <- ys, x == y ]) | x <- xs]

prop_nestjoin3 :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_length :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_length_nub :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum_length :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum_length2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum_deep :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_length_guard :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_length_guard2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum_nest :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_sum_nest2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_nestjoin :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_nestjoin_guard :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_groupjoin_length_deep_sum :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_aj_class12 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_aj_class15 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_aj_class16 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
prop_backdep :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_backdep = makePropEq C.backdep backdep_native
  where
    backdep_native xss = [x | xs <- xss, x <- xs]

prop_backdep_filter :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_backdep2 :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_backdep2 = makePropEq C.backdep2 backdep2
  where
    backdep2 xss = [ [ x * 42 | x <- xs ] | xs <- xss ]

prop_backdep3 :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_backdep3 = makePropEq C.backdep3 backdep3
  where
    backdep3 xss = [ [ x + fromIntegral (length xs) | x <- xs ] | xs <- xss ]

prop_backdep4 :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
...
prop_backdep5 :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_njg6 :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
prop_njg6 = makePropEq (\(Q.view -> (xs, ys, zs)) -> C.njg6 xs ys zs)
                       (\(xs, ys, zs) -> njg6 xs ys zs)

prop_njg7 :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
...
prop_liftsemijoin :: (Backend b, VectorLang v) => ([Positive Integer], [Integer]) -> DSHProperty v b
...
prop_liftantijoin :: (Backend b, VectorLang v) => ([Positive Integer], [Integer]) -> DSHProperty v b
...
prop_liftthetajoin :: (Backend b, VectorLang v) => ([Positive Integer], [Integer]) -> DSHProperty v b
...
heqjoin_nested1 :: (Backend b, VectorLang v) => DSHAssertion v b
...
prop_deep_iter :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer], [Integer], [Integer]) -> DSHProperty v b
...
-- from a nested list.
prop_only_tuple :: (Backend b, VectorLang v)
