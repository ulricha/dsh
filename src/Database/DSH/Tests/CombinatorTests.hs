...
liftedTests conn = testGroup "Lifted operations"
    ...
    , testPropertyConn conn "map groupagg (sum, length)"            prop_map_groupagg_sum_length
    , testPropertyConn conn "map groupagg key  (sum, length)"       prop_map_groupaggkey_sum_length
    , testPropertyConn conn "map groupagg (sum, length, max)"       prop_map_groupagg_sum_length_max
...
prop_map_groupagg_sum_length :: Backend c => [[Integer]] -> c -> Property
...
prop_map_groupaggkey_sum_length :: Backend c => [[Integer]] -> c -> Property
...
prop_map_groupagg_sum_length_max :: Backend c => [[Integer]] -> c -> Property
