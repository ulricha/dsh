...
typeTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
booleanTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
tupleTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
numericTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
maybeTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
eitherTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
listTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
liftedTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
distTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
otherTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
hunitCombinatorTests :: (Backend b, VectorLang v) => DSHTestTree v b
...
prop_unit :: (Backend b, VectorLang v) => () -> DSHProperty v b
prop_unit = makePropEq id id

prop_bool :: (Backend b, VectorLang v) => Bool -> DSHProperty v b
prop_bool = makePropEq id id

prop_integer :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_integer = makePropEq id id

prop_double :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_double d = makePropDouble id id (getFixed d)

prop_char :: (Backend b, VectorLang v) => Char -> DSHProperty v b
prop_char c codeGen conn = c /= '\0' ==> makePropEq id id c codeGen conn

prop_text :: (Backend b, VectorLang v) => Text -> DSHProperty v b
prop_text t = makePropEq id id (filterNullChar t)

prop_day :: (Backend b, VectorLang v) => C.Day -> DSHProperty v b
prop_day = makePropEq id id

prop_decimal :: (Backend b, VectorLang v) => (Positive Word8, Integer) -> DSHProperty v b
prop_decimal (p, m) = makePropEq id id (D.Decimal (getPositive p) m)

prop_scientific :: (Backend b, VectorLang v) => (Integer, Int) -> DSHProperty v b
prop_scientific (p, m) = makePropEq id id (S.scientific p m)

prop_list_integer_1 :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_list_integer_1 = makePropEq id id

prop_list_integer_2 :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_list_integer_2 = makePropEq id id

prop_list_integer_3 :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_list_integer_3 = makePropEq id id

prop_list_tuple_integer :: (Backend b, VectorLang v) => [(Integer, Integer)] -> DSHProperty v b
prop_list_tuple_integer = makePropEq id id

prop_maybe_integer :: (Backend b, VectorLang v) => Maybe Integer -> DSHProperty v b
prop_maybe_integer = makePropEq id id

prop_tuple_list_integer2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_tuple_list_integer2 = makePropEq id id

prop_tuple_list_integer3 :: (Backend b, VectorLang v) => ([Integer], [Integer], [Integer]) -> DSHProperty v b
prop_tuple_list_integer3 = makePropEq id id

prop_tuple_integer_list :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_tuple_integer_list = makePropEq id id

prop_tuple_integer_list_integer :: (Backend b, VectorLang v) => (Integer, [Integer], Integer) -> DSHProperty v b
prop_tuple_integer_list_integer = makePropEq id id

prop_either_integer :: (Backend b, VectorLang v) => Either Integer Integer -> DSHProperty v b
prop_either_integer = makePropEq id id

prop_tuple4 :: (Backend b, VectorLang v) => [(Integer, Integer, Integer, Integer)] -> DSHProperty v b
prop_tuple4 = makePropEq (Q.map (\(Q.view -> (a, b, c, d)) -> Q.tup4 (a + c) (b - d) b d))
                         (map (\(a, b, c, d) -> (a + c, b - d, b, d)))

prop_tuple5 :: (Backend b, VectorLang v) => [(Integer, Integer, Integer, Integer, Integer)] -> DSHProperty v b
prop_tuple5 = makePropEq (Q.map (\(Q.view -> (a, _, c, _, e)) -> Q.tup3 a c e))
                         (map (\(a, _, c, _, e) -> (a, c, e)))

-- {-

-- prop_d0 :: (Backend b, VectorLang v) => D0 -> DSHProperty v b
-- prop_d0 = makePropEq id id

-- prop_d1 :: (Backend b, VectorLang v) => D1 Integer -> DSHProperty v b
-- prop_d1 = makePropEq id id

-- prop_d2 :: (Backend b, VectorLang v) => D2 Integer Integer -> DSHProperty v b
-- prop_d2 = makePropEq id id

-- prop_d3 :: (Backend b, VectorLang v) => D3 -> DSHProperty v b
-- prop_d3 = makePropEq id id

-- prop_d4 :: (Backend b, VectorLang v) => D4 Integer -> DSHProperty v b
-- prop_d4 = makePropEq id id

-- prop_d5 :: (Backend b, VectorLang v) => D5 Integer -> DSHProperty v b
-- prop_d5 = makePropEq id id

-- prop_d6 :: (Backend b, VectorLang v) => D6 Integer Integer Integer Integer Integer -> DSHProperty v b
...
prop_infix_and :: (Backend b, VectorLang v) => (Bool,Bool) -> DSHProperty v b
prop_infix_and = makePropEq (uncurryQ (Q.&&)) (uncurry (&&))

prop_infix_map_and :: (Backend b, VectorLang v) => (Bool, [Bool]) -> DSHProperty v b
prop_infix_map_and = makePropEq (\x -> Q.map (Q.fst x Q.&&) $ Q.snd x) (\(x,xs) -> map (x &&) xs)

prop_infix_or :: (Backend b, VectorLang v) => (Bool,Bool) -> DSHProperty v b
prop_infix_or = makePropEq (uncurryQ (Q.||)) (uncurry (||))

prop_infix_map_or :: (Backend b, VectorLang v) => (Bool, [Bool]) -> DSHProperty v b
prop_infix_map_or = makePropEq (\x -> Q.map (Q.fst x Q.||) $ Q.snd x) (\(x,xs) -> map (x ||) xs)

prop_not :: (Backend b, VectorLang v) => Bool -> DSHProperty v b
prop_not = makePropEq Q.not not

prop_map_not :: (Backend b, VectorLang v) => [Bool] -> DSHProperty v b
prop_map_not = makePropEq (Q.map Q.not) (map not)

prop_eq :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_eq = makePropEq (uncurryQ (Q.==)) (uncurry (==))

prop_map_eq :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_eq = makePropEq (\x -> Q.map (Q.fst x Q.==) $ Q.snd x) (\(x,xs) -> map (x ==) xs)

prop_neq :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_neq = makePropEq (uncurryQ (Q./=)) (uncurry (/=))

prop_map_neq :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_neq = makePropEq (\x -> Q.map (Q.fst x Q./=) $ Q.snd x) (\(x,xs) -> map (x /=) xs)

prop_cond :: (Backend b, VectorLang v) => Bool -> DSHProperty v b
prop_cond = makePropEq (\b -> Q.cond b 0 1) (\b -> if b then (0 :: Integer) else 1)

prop_cond_tuples :: (Backend b, VectorLang v) => (Bool, (Integer, Integer)) -> DSHProperty v b
...
prop_cond_list_tuples :: (Backend b, VectorLang v) => (Bool, ([[Integer]], [[Integer]])) -> DSHProperty v b
...
prop_map_cond :: (Backend b, VectorLang v) => [Bool] -> DSHProperty v b
prop_map_cond = makePropEq (Q.map (\b -> Q.cond b (0 :: Q.Q Integer) 1))
                         (map (\b -> if b then 0 else 1))

prop_map_cond_tuples :: (Backend b, VectorLang v) => [Bool] -> DSHProperty v b
...
prop_concatmapcond :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_concatmapcond =
    makePropEq q n
...
prop_lt :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_lt = makePropEq (uncurryQ (Q.<)) (uncurry (<))

prop_map_lt :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_lt = makePropEq (\x -> Q.map (Q.fst x Q.<) $ Q.snd x) (\(x,xs) -> map (x <) xs)

prop_lte :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_lte = makePropEq (uncurryQ (Q.<=)) (uncurry (<=))

prop_map_lte :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_lte = makePropEq (\x -> Q.map (Q.fst x Q.<=) $ Q.snd x) (\(x,xs) -> map (x <=) xs)

prop_gt :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_gt = makePropEq (uncurryQ (Q.>)) (uncurry (>))

prop_map_gt :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_gt = makePropEq (\x -> Q.map (Q.fst x Q.>) $ Q.snd x) (\(x,xs) -> map (x >) xs)

prop_gte :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_gte = makePropEq (uncurryQ (Q.>=)) (uncurry (>=))

prop_map_gte :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_map_gte = makePropEq (\x -> Q.map (Q.fst x Q.>=) $ Q.snd x) (\(x,xs) -> map (x >=) xs)

prop_min_integer :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_min_integer = makePropEq (uncurryQ Q.min) (uncurry min)

prop_max_integer :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_max_integer = makePropEq (uncurryQ Q.max) (uncurry max)

prop_min_double :: (Backend b, VectorLang v) => (Fixed Double, Fixed Double) -> DSHProperty v b
prop_min_double (d1, d2) = makePropDouble (uncurryQ Q.min) (uncurry min) (getFixed d1, getFixed d2)

prop_max_double :: (Backend b, VectorLang v) => (Fixed Double, Fixed Double) -> DSHProperty v b
prop_max_double (d1, d2) = makePropDouble (uncurryQ Q.max) (uncurry max) (getFixed d1, getFixed d2)

-- * Maybe

prop_maybe :: (Backend b, VectorLang v) => (Integer, Maybe Integer) -> DSHProperty v b
prop_maybe =  makePropEq (\a -> Q.maybe (Q.fst a) id (Q.snd a)) (\(i,mi) -> maybe i id mi)

prop_just :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_just = makePropEq Q.just Just

prop_isJust :: (Backend b, VectorLang v) => Maybe Integer -> DSHProperty v b
prop_isJust = makePropEq Q.isJust isJust

prop_isNothing :: (Backend b, VectorLang v) => Maybe Integer -> DSHProperty v b
prop_isNothing = makePropEq Q.isNothing isNothing

prop_fromJust :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_fromJust i = makePropEq Q.fromJust fromJust (Just i)

prop_fromMaybe :: (Backend b, VectorLang v) => (Integer,Maybe Integer) -> DSHProperty v b
prop_fromMaybe = makePropEq (uncurryQ Q.fromMaybe) (uncurry fromMaybe)

prop_listToMaybe :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_listToMaybe = makePropEq Q.listToMaybe listToMaybe

prop_maybeToList :: (Backend b, VectorLang v) => Maybe Integer -> DSHProperty v b
prop_maybeToList = makePropEq Q.maybeToList maybeToList

prop_catMaybes :: (Backend b, VectorLang v) => [Maybe Integer] -> DSHProperty v b
prop_catMaybes = makePropEq Q.catMaybes catMaybes

prop_mapMaybe :: (Backend b, VectorLang v) => [Maybe Integer] -> DSHProperty v b
prop_mapMaybe = makePropEq (Q.mapMaybe id) (mapMaybe id)

-- * Either

prop_left :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_left = makePropEq (Q.left :: Q.Q Integer -> Q.Q (Either Integer Integer)) Left

prop_right :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_right = makePropEq (Q.right :: Q.Q Integer -> Q.Q (Either Integer Integer)) Right

prop_isLeft :: (Backend b, VectorLang v) => Either Integer Integer -> DSHProperty v b
prop_isLeft = makePropEq Q.isLeft (\e -> case e of {Left _ -> True; Right _ -> False;})

prop_isRight :: (Backend b, VectorLang v) => Either Integer Integer -> DSHProperty v b
prop_isRight = makePropEq Q.isRight (\e -> case e of {Left _ -> False; Right _ -> True;})

prop_either :: (Backend b, VectorLang v) => Either Integer Integer -> DSHProperty v b
prop_either =  makePropEq (Q.either id id) (either id id)

prop_lefts :: (Backend b, VectorLang v) => [Either Integer Integer] -> DSHProperty v b
prop_lefts =  makePropEq Q.lefts lefts

prop_rights :: (Backend b, VectorLang v) => [Either Integer Integer] -> DSHProperty v b
prop_rights =  makePropEq Q.rights rights

prop_partitionEithers :: (Backend b, VectorLang v) => [Either Integer Integer] -> DSHProperty v b
prop_partitionEithers =  makePropEq Q.partitionEithers partitionEithers

-- * Lists

prop_cons :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_cons = makePropEq (uncurryQ (Q.<|)) (uncurry (:))

prop_map_cons :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_cons = makePropEq (\x -> Q.map (Q.fst x Q.<|) $ Q.snd x)
                         (\(x,xs) -> map (x:) xs)

prop_snoc :: (Backend b, VectorLang v) => ([Integer], Integer) -> DSHProperty v b
prop_snoc = makePropEq (uncurryQ (Q.|>)) (\(a,b) -> a ++ [b])

prop_map_snoc :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_map_snoc = makePropEq (\z -> Q.map (Q.fst z Q.|>) (Q.snd z)) (\(a,b) -> map (\z -> a ++ [z]) b)

prop_singleton :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_singleton = makePropEq Q.singleton (: [])

prop_head :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_head (NonEmpty is) = makePropEq Q.head head is

prop_tail :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_tail (NonEmpty is) = makePropEq Q.tail tail is

prop_last :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_last (NonEmpty is) = makePropEq Q.last last is

prop_map_last :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
prop_map_last ps =
    makePropEq (Q.map Q.last) (map last) (map getNonEmpty ps)

prop_init :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_init (NonEmpty is) = makePropEq Q.init init is

prop_map_init  :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
prop_map_init ps =
    makePropEq (Q.map Q.init) (map init) (map getNonEmpty ps)

prop_the   :: (Backend b, VectorLang v) => (Positive Int, Integer) -> DSHProperty v b
prop_the (n, i) =
    makePropEq Q.head the l
  where
    l = replicate (getPositive n) i

prop_map_the :: (Backend b, VectorLang v) => [(Positive Int, Integer)] -> DSHProperty v b
prop_map_the ps =
    makePropEq (Q.map Q.head) (map the) xss
  where
    xss = map (\(Positive n, i) -> replicate n i) ps

prop_map_tail :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
prop_map_tail ps =
    makePropEq (Q.map Q.tail) (map tail) (map getNonEmpty ps)

prop_index :: (Backend b, VectorLang v) => ([Integer], NonNegative Integer)  -> DSHProperty v b
...
prop_index_pair :: (Backend b, VectorLang v) => ([(Integer, [Integer])], NonNegative Integer) -> DSHProperty v b
...
prop_index_nest :: (Backend b, VectorLang v) => ([[Integer]], NonNegative Integer)  -> DSHProperty v b
...
prop_map_index2 :: (Backend b, VectorLang v) => (NonEmptyList Integer, [NonNegative Integer]) -> DSHProperty v b
...
prop_map_index :: (Backend b, VectorLang v) => ([Integer], [NonNegative Integer])  -> DSHProperty v b
...
prop_map_index_nest :: (Backend b, VectorLang v) => ([[Integer]], [NonNegative Integer])  -> DSHProperty v b
...
prop_take :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_take = makePropEq (uncurryQ Q.take) (\(n,l) -> take (fromIntegral n) l)

prop_map_take :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_take = makePropEq (\z -> Q.map (Q.take $ Q.fst z) $ Q.snd z)
                           (\(n,l) -> map (take (fromIntegral n)) l)

prop_drop :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_drop = makePropEq (uncurryQ Q.drop) (\(n,l) -> drop (fromIntegral n) l)

prop_map_drop :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
...
prop_map :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_map = makePropEq (Q.map id) (map id)

prop_map_map_mul :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_map_mul = makePropEq (Q.map (Q.map (*2))) (map (map (*2)))

prop_map_map_add :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_map_map_add = makePropEq (\z -> Q.map (\x -> (Q.map (\y -> x + y) $ Q.snd z))
                                           (Q.fst z))
                              (\(l,r) -> map (\x -> map (\y -> x + y) r) l)

prop_map_map_map_mul :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_map_map_map_mul = makePropEq (Q.map (Q.map (Q.map (*2)))) (map (map (map (*2))))

prop_append :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_append = makePropEq (uncurryQ (Q.++)) (uncurry (++))

prop_append_nest :: (Backend b, VectorLang v) => ([[Integer]], [[Integer]]) -> DSHProperty v b
prop_append_nest = makePropEq (uncurryQ (Q.append)) (\(a,b) -> a ++ b)

prop_map_append :: (Backend b, VectorLang v) => ([Integer], [[Integer]]) -> DSHProperty v b
prop_map_append = makePropEq (\z -> Q.map (Q.fst z Q.++) (Q.snd z)) (\(a,b) -> map (a ++) b)

prop_filter :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_filter = makePropEq (Q.filter (const $ Q.toQ True)) (filter $ const True)

prop_filter_gt :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_filter_gt = makePropEq (Q.filter (Q.> 42)) (filter (> 42))

prop_filter_gt_nested :: (Backend b, VectorLang v) => [(Integer, [Integer])] -> DSHProperty v b
prop_filter_gt_nested = makePropEq (Q.filter ((Q.> 42) . Q.fst)) (filter ((> 42) . fst))

prop_map_filter :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_filter = makePropEq (Q.map (Q.filter (const $ Q.toQ True))) (map (filter $ const True))

prop_map_filter_gt :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_filter_gt = makePropEq (Q.map (Q.filter (Q.> 42))) (map (filter (> 42)))

prop_map_filter_gt_nested :: (Backend b, VectorLang v) => [[(Integer, [Integer])]] -> DSHProperty v b
prop_map_filter_gt_nested = makePropEq (Q.map (Q.filter ((Q.> 42) . Q.fst))) (map (filter ((> 42) . fst)))

prop_groupWith :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
...
prop_groupWithKey :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_groupWithKey = makePropEq (Q.groupWithKey id) (groupWithKey id)

prop_map_groupWith_rem :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_groupWith_rem = makePropEq (Q.map (Q.groupWith (`Q.rem` 10)))
                                    (map (groupWith (`rem` 10)))

prop_map_groupWith :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_groupWith = makePropEq (Q.map (Q.groupWith id)) (map (groupWith id))

prop_map_groupWithKey :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_groupWithKey = makePropEq (Q.map (Q.groupWithKey id)) (map (groupWithKey id))

prop_groupWith_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_groupWith_length = makePropEq (Q.groupWith Q.length) (groupWith length)

prop_groupWithKey_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_groupWithKey_length = makePropEq (Q.groupWithKey Q.length) (groupWithKey (fromIntegral . length))

prop_groupagg_sum :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_groupagg_sum = makePropEq (Q.map Q.sum . Q.groupWith (`Q.rem` 10))
                               (map sum . groupWith (`rem` 10))

prop_groupaggkey_sum :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
...
prop_groupaggkey_sum_length :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
...
prop_groupagg_sum_length_max :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
...
prop_map_groupagg_sum_exp :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_map_groupagg_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_map_groupagg_minimum :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
...
prop_map_groupagg_maximum :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
...
prop_map_groupagg_sum_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_map_groupaggkey_sum_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_map_groupagg_sum_length_max :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
...
prop_sortWith_length_nest  :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_sortWith_length_nest = makePropEq (Q.sortWith Q.length) (sortWith length)

prop_groupWith_length_nest :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_groupWith_length_nest = makePropEq (Q.groupWith Q.length) (groupWith length)

prop_groupWithKey_length_nest :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_groupWithKey_length_nest = makePropEq (Q.groupWithKey Q.length)
                                           (groupWithKey (fromIntegral . length))

prop_null :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_null = makePropEq Q.null null

prop_map_null :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_null = makePropEq (Q.map Q.null) (map null)

prop_length :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_length = makePropEq Q.length ((fromIntegral :: Int -> Integer) . length)

prop_length_tuple :: (Backend b, VectorLang v) => [(Integer, Integer)] -> DSHProperty v b
prop_length_tuple = makePropEq Q.length (fromIntegral . length)

prop_map_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_length = makePropEq (Q.map Q.length) (map (fromIntegral . length))

prop_map_minimum :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
...
prop_map_maximum :: (Backend b, VectorLang v) => [NonEmptyList Integer] -> DSHProperty v b
...
prop_map_map_minimum :: (Backend b, VectorLang v) => [[NonEmptyList Integer]] -> DSHProperty v b
...
prop_map_map_maximum :: (Backend b, VectorLang v) => [[NonEmptyList Integer]] -> DSHProperty v b
...
prop_map_length_tuple :: (Backend b, VectorLang v) => [[(Integer, Integer)]] -> DSHProperty v b
prop_map_length_tuple = makePropEq (Q.map Q.length) (map (fromIntegral . length))

prop_reverse :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_reverse = makePropEq Q.reverse reverse

prop_reverse_nest :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_reverse_nest = makePropEq Q.reverse reverse

prop_map_reverse :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_reverse = makePropEq (Q.map Q.reverse) (map reverse)

prop_map_reverse_nest :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_map_reverse_nest = makePropEq (Q.map Q.reverse) (map reverse)

prop_and :: (Backend b, VectorLang v) => [Bool] -> DSHProperty v b
prop_and = makePropEq Q.and and

prop_map_and :: (Backend b, VectorLang v) => [[Bool]] -> DSHProperty v b
prop_map_and = makePropEq (Q.map Q.and) (map and)

prop_map_map_and :: (Backend b, VectorLang v) => [[[Bool]]] -> DSHProperty v b
prop_map_map_and = makePropEq (Q.map (Q.map Q.and)) (map (map and))

prop_or :: (Backend b, VectorLang v) => [Bool] -> DSHProperty v b
prop_or = makePropEq Q.or or

prop_map_or :: (Backend b, VectorLang v) => [[Bool]] -> DSHProperty v b
prop_map_or = makePropEq (Q.map Q.or) (map or)

prop_map_map_or :: (Backend b, VectorLang v) => [[[Bool]]] -> DSHProperty v b
prop_map_map_or = makePropEq (Q.map (Q.map Q.or)) (map (map or))

prop_any_zero :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_any_zero = makePropEq (Q.any (Q.== 0)) (any (== 0))

prop_map_any_zero :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_any_zero = makePropEq (Q.map (Q.any (Q.== 0))) (map (any (== 0)))

prop_all_zero :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_all_zero = makePropEq (Q.all (Q.== 0)) (all (== 0))

prop_map_all_zero :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_all_zero = makePropEq (Q.map (Q.all (Q.== 0))) (map (all (== 0)))

prop_sum_integer :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_sum_integer = makePropEq Q.sum sum

prop_map_sum :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_sum = makePropEq (Q.map Q.sum) (map sum)

prop_map_avg :: (Backend b, VectorLang v) => [NonEmptyList (Fixed Double)] -> DSHProperty v b
prop_map_avg is =
    makePropDoubles (Q.map Q.avg) (map avgDouble) (map (map getFixed . getNonEmpty) is)

prop_map_map_sum :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_map_map_sum = makePropEq (Q.map (Q.map Q.sum)) (map (map sum))

-- prop_map_map_avg :: (Backend b, VectorLang v) => [[NonEmptyList Integer]] -> DSHProperty v b
...
prop_sum_double :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
...
prop_avg_double :: (Backend b, VectorLang v) => NonEmptyList (Fixed Double) -> DSHProperty v b
prop_avg_double ds conn = makePropDouble Q.avg avgDouble (map getFixed $ getNonEmpty ds) conn

prop_concat :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_concat = makePropEq Q.concat concat

prop_map_concat :: (Backend b, VectorLang v) => [[[Integer]]] -> DSHProperty v b
prop_map_concat = makePropEq (Q.map Q.concat) (map concat)

prop_concatMap :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_concatMap = makePropEq (Q.concatMap Q.singleton) (concatMap (: []))

prop_maximum :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_maximum (NonEmpty is) = makePropEq Q.maximum maximum is

prop_minimum :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
prop_minimum (NonEmpty is) = makePropEq Q.minimum minimum is

prop_splitAt :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_splitAt = makePropEq (uncurryQ Q.splitAt) (\(a,b) -> splitAt (fromIntegral a) b)

prop_takeWhile :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_takeWhile = makePropEq (uncurryQ $ Q.takeWhile . (Q.==))
                          (uncurry  $   takeWhile . (==))

prop_dropWhile :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_dropWhile = makePropEq (uncurryQ $ Q.dropWhile . (Q.==))
                          (uncurry  $   dropWhile . (==))

prop_map_takeWhile :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_takeWhile = makePropEq (\z -> Q.map (Q.takeWhile (Q.fst z Q.==)) (Q.snd z))
                              (\z -> map (takeWhile (fst z ==)) (snd z))

prop_map_dropWhile :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_dropWhile = makePropEq (\z -> Q.map (Q.dropWhile (Q.fst z Q.==)) (Q.snd z))
                              (\z -> map (dropWhile (fst z ==)) (snd z))

prop_span :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_span = makePropEq (uncurryQ $ Q.span . (Q.==))
                     (uncurry   $   span . (==) . fromIntegral)

prop_map_span :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_span = makePropEq (\z -> Q.map (Q.span ((Q.fst z) Q.==)) (Q.snd z))
                         (\z -> map (span (fst z ==)) (snd z))

prop_break :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_break = makePropEq (uncurryQ $ Q.break . (Q.==))
                      (uncurry   $   break . (==) . fromIntegral)

prop_map_break :: (Backend b, VectorLang v) => (Integer, [[Integer]]) -> DSHProperty v b
prop_map_break = makePropEq (\z -> Q.map (Q.break ((Q.fst z) Q.==)) (Q.snd z))
                          (\z -> map (break (fst z ==)) (snd z))

prop_elem :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_elem = makePropEq (uncurryQ Q.elem)
                     (uncurry    elem)

prop_notElem :: (Backend b, VectorLang v) => (Integer, [Integer]) -> DSHProperty v b
prop_notElem = makePropEq (uncurryQ Q.notElem)
                        (uncurry    notElem)

prop_lookup :: (Backend b, VectorLang v) => (Integer, [(Integer,Integer)]) -> DSHProperty v b
prop_lookup = makePropEq (uncurryQ Q.lookup)
                       (uncurry    lookup)

prop_zip :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_zip = makePropEq (uncurryQ Q.zip) (uncurry zip)

prop_zip_nested :: (Backend b, VectorLang v) => ([Integer], [(Integer, [Integer])]) -> DSHProperty v b
prop_zip_nested = makePropEq (uncurryQ Q.zip) (uncurry zip)

prop_zip_tuple1 :: (Backend b, VectorLang v) => ([Integer], [(Text, Integer)]) -> DSHProperty v b
prop_zip_tuple1 (xs, tds) =
    makePropEq (uncurryQ Q.zip) (uncurry zip) (xs, tds')
  where
    tds' = map (\(t, d) -> (filterNullChar t, d)) tds

prop_zip_tuple2 :: (Backend b, VectorLang v)
...
prop_map_zip :: (Backend b, VectorLang v) => ([Integer], [[Integer]]) -> DSHProperty v b
prop_map_zip = makePropEq (\z -> Q.map (Q.zip $ Q.fst z) $ Q.snd z) (\(x, y) -> map (zip x) y)

prop_zipWith :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_zipWith = makePropEq (uncurryQ $ Q.zipWith (+)) (uncurry $ zipWith (+))

prop_unzip :: (Backend b, VectorLang v) => [(Integer, Integer)] -> DSHProperty v b
prop_unzip = makePropEq Q.unzip unzip

prop_map_unzip :: (Backend b, VectorLang v) => [[(Integer, Integer)]] -> DSHProperty v b
prop_map_unzip = makePropEq (Q.map Q.unzip) (map unzip)

prop_zip3 :: (Backend b, VectorLang v) => ([Integer], [Integer],[Integer]) -> DSHProperty v b
prop_zip3 = makePropEq (\q -> (case Q.view q of (as,bs,cs) -> Q.zip3 as bs cs))
                     (\(as,bs,cs) -> zip3 as bs cs)

prop_zipWith3 :: (Backend b, VectorLang v) => ([Integer], [Integer],[Integer]) -> DSHProperty v b
...
prop_unzip3 :: (Backend b, VectorLang v) => [(Integer, Integer, Integer)] -> DSHProperty v b
prop_unzip3 = makePropEq Q.unzip3 unzip3

prop_nub :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_nub = makePropEq Q.nub nub

prop_map_nub :: (Backend b, VectorLang v) => [[(Integer, Integer)]] -> DSHProperty v b
prop_map_nub = makePropEq (Q.map Q.nub) (map nub)

-- * Tuples

prop_fst :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_fst = makePropEq Q.fst fst

prop_fst_nested :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_fst_nested = makePropEq Q.fst fst

prop_map_fst :: (Backend b, VectorLang v) => [(Integer, Integer)] -> DSHProperty v b
prop_map_fst = makePropEq (Q.map Q.fst) (map fst)

prop_snd :: (Backend b, VectorLang v) => (Integer, Integer) -> DSHProperty v b
prop_snd = makePropEq Q.snd snd

prop_map_snd :: (Backend b, VectorLang v) => [(Integer, Integer)] -> DSHProperty v b
prop_map_snd = makePropEq (Q.map Q.snd) (map snd)

prop_snd_nested :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_snd_nested = makePropEq Q.snd snd

prop_tup3_1 :: (Backend b, VectorLang v) => (Integer, Integer, Integer) -> DSHProperty v b
prop_tup3_1 = makePropEq (\q -> case Q.view q of (a, _, _) -> a) (\(a, _, _) -> a)

prop_tup3_2 :: (Backend b, VectorLang v) => (Integer, Integer, Integer) -> DSHProperty v b
prop_tup3_2 = makePropEq (\q -> case Q.view q of (_, b, _) -> b) (\(_, b, _) -> b)

prop_tup3_3 :: (Backend b, VectorLang v) => (Integer, Integer, Integer) -> DSHProperty v b
prop_tup3_3 = makePropEq (\q -> case Q.view q of (_, _, c) -> c) (\(_, _, c) -> c)

prop_tup4_2 :: (Backend b, VectorLang v) => (Integer, Integer, Integer, Integer) -> DSHProperty v b
prop_tup4_2 = makePropEq (\q -> case Q.view q of (_, b, _, _) -> b) (\(_, b, _, _) -> b)

prop_tup4_4 :: (Backend b, VectorLang v) => (Integer, Integer, Integer, Integer) -> DSHProperty v b
prop_tup4_4 = makePropEq (\q -> case Q.view q of (_, _, _, d) -> d) (\(_, _, _, d) -> d)

prop_tup3_nested :: (Backend b, VectorLang v) => (Integer, [Integer], Integer) -> DSHProperty v b
prop_tup3_nested = makePropEq (\q -> case Q.view q of (_, b, _) -> b) (\(_, b, _) -> b)

prop_tup4_tup3 :: (Backend b, VectorLang v) => (Integer, Integer, Integer, Integer) -> DSHProperty v b
prop_tup4_tup3 = makePropEq (\q -> case Q.view q of (a, b, _, d) -> Q.tup3 a b d)
                          (\(a, b, _, d) -> (a, b, d))

prop_agg_tuple :: (Backend b, VectorLang v) => NonEmptyList Integer -> DSHProperty v b
...
prop_add_integer :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_add_integer = makePropEq (uncurryQ (+)) (uncurry (+))

prop_add_integer_sums :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_add_integer_sums = makePropEq (\p -> Q.sum (Q.fst p) + Q.sum (Q.snd p))
                                   (\p -> sum (fst p) + sum (snd p))

prop_add_double :: (Backend b, VectorLang v) => (Fixed Double, Fixed Double) -> DSHProperty v b
prop_add_double (d1, d2) = makePropDouble (uncurryQ (+)) (uncurry (+)) (getFixed d1, getFixed d2)

prop_mul_integer :: (Backend b, VectorLang v) => (Integer,Integer) -> DSHProperty v b
prop_mul_integer = makePropEq (uncurryQ (*)) (uncurry (*))

prop_mul_double :: (Backend b, VectorLang v) => (Fixed Double, Fixed Double) -> DSHProperty v b
prop_mul_double (d1, d2) = makePropDouble (uncurryQ (*)) (uncurry (*)) (getFixed d1, getFixed d2)

prop_div_double :: (Backend b, VectorLang v) => (Fixed Double, Fixed (NonZero Double)) -> DSHProperty v b
prop_div_double (Fixed x, Fixed (NonZero y)) =
    makePropDouble (uncurryQ (/)) (uncurry (/)) (x,y)

prop_integer_to_double :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_integer_to_double = makePropDouble Q.integerToDouble fromInteger

prop_integer_to_double_arith :: (Backend b, VectorLang v) => (Integer, Fixed Double) -> DSHProperty v b
prop_integer_to_double_arith (i, d) = makePropDouble (\x -> (Q.integerToDouble (Q.fst x)) + (Q.snd x))
                                                     (\(ni, nd) -> fromInteger ni + nd)
                                                     (i, getFixed d)

prop_map_integer_to_double :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_map_integer_to_double = makePropDoubles (Q.map Q.integerToDouble) (map fromInteger)

prop_abs_integer :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_abs_integer = makePropEq Q.abs abs

prop_abs_double :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_abs_double d = makePropDouble Q.abs abs (getFixed d)

prop_signum_integer :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_signum_integer = makePropEq Q.signum signum

prop_signum_double :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_signum_double d = makePropDouble Q.signum signum (getFixed d)

prop_negate_integer :: (Backend b, VectorLang v) => Integer -> DSHProperty v b
prop_negate_integer = makePropEq Q.negate negate

prop_negate_double :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_negate_double d = makePropDouble Q.negate negate (getFixed d)

prop_trig_sin :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_sin d = makePropDouble Q.sin sin (getFixed d)

prop_trig_cos :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_cos d = makePropDouble Q.cos cos (getFixed d)

prop_trig_tan :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_tan d = makePropDouble Q.tan tan (getFixed d)

prop_exp :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_exp d codeGen conn = d >= (-5) && d <= 5 ==> makePropDouble Q.exp exp (getFixed d) codeGen conn

prop_rem :: (Backend b, VectorLang v) => Fixed Integer -> DSHProperty v b
prop_rem d = makePropEq (`Q.rem` 10) (`rem` 10) (getFixed d)

prop_log :: (Backend b, VectorLang v) => Fixed (Positive Double) -> DSHProperty v b
prop_log d = makePropDouble Q.log log (getPositive $ getFixed d)

prop_sqrt :: (Backend b, VectorLang v) => Fixed (Positive Double) -> DSHProperty v b
prop_sqrt d = makePropDouble Q.sqrt sqrt (getPositive $ getFixed d)

arc :: (Ord a, Num a) => a -> Bool
arc d = d >= -1 && d <= 1

prop_trig_asin :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_asin d codeGen conn = arc d ==>  makePropDouble Q.asin asin (getFixed d) codeGen conn

prop_trig_acos :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_acos d codeGen conn = arc d ==> makePropDouble Q.acos acos (getFixed d) codeGen conn

prop_trig_atan :: (Backend b, VectorLang v) => Fixed Double -> DSHProperty v b
prop_trig_atan d = makePropDouble Q.atan atan (getFixed d)

prop_number :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_number = makePropEq (Q.map Q.snd . Q.number) (\xs -> map snd $ zip xs [1..])

prop_map_number :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_number = makePropEq (Q.map (Q.map Q.snd . Q.number))
                            (map (\xs -> map snd $ zip xs [1..]))


prop_map_trig_sin :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_sin ds = makePropDoubles (Q.map Q.sin) (map sin) (map getFixed ds)

prop_map_trig_cos :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_cos ds = makePropDoubles (Q.map Q.cos) (map cos) (map getFixed ds)

prop_map_trig_tan :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_tan ds = makePropDoubles (Q.map Q.tan) (map tan) (map getFixed ds)

prop_map_trig_asin :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_asin ds codeGen conn =
    all arc ds
    ==>
    makePropDoubles (Q.map Q.asin) (map asin) (map getFixed ds) codeGen conn

prop_map_trig_acos :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_acos ds codeGen conn =
    all arc ds
    ==>
    makePropDoubles (Q.map Q.acos) (map acos) (map getFixed ds) codeGen conn

prop_map_trig_atan :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_trig_atan ds = makePropDoubles (Q.map Q.atan) (map atan) (map getFixed ds)

prop_map_exp :: (Backend b, VectorLang v) => [Fixed Double] -> DSHProperty v b
prop_map_exp ds codeGen conn =
    all (\d -> d >= (-5) && d <= 5) ds
    ==>
    makePropDoubles (Q.map Q.exp) (map exp) (map getFixed ds) codeGen conn

prop_map_rem :: (Backend b, VectorLang v) => [Fixed Integer] -> DSHProperty v b
prop_map_rem d = makePropEq (Q.map (`Q.rem` 10)) (map (`rem` 10)) (map getFixed d)

prop_map_log :: (Backend b, VectorLang v) => [Fixed (Positive Double)] -> DSHProperty v b
prop_map_log ds = makePropDoubles (Q.map Q.log) (map log) (map (getPositive . getFixed) ds)

prop_map_sqrt :: (Backend b, VectorLang v) => [Fixed (Positive Double)] -> DSHProperty v b
prop_map_sqrt ds =
    makePropDoubles (Q.map Q.sqrt) (map sqrt) (map (getPositive . getFixed) ds)

prop_dist_scalar :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
prop_dist_scalar = makePropEq (\p -> Q.map (\i -> Q.sum (Q.fst p) + i) (Q.snd p))
                              (\p -> map (\i -> sum (fst p) + i) (snd p))

prop_dist_list1 :: (Backend b, VectorLang v) => ([Integer], [[Integer]]) -> DSHProperty v b
prop_dist_list1 = makePropEq (\p -> Q.map (\xs -> (Q.fst p) Q.++ xs) (Q.snd p))
                             (\p -> map (\xs -> (fst p) ++ xs) (snd p))

prop_dist_list2 :: (Backend b, VectorLang v) => ([Integer], [Integer]) -> DSHProperty v b
...
test_dist_lift :: (Backend b, VectorLang v) => DSHAssertion v b
...
hnegative_sum :: (Backend b, VectorLang v) => DSHAssertion v b
hnegative_sum = makeEqAssertion "hnegative_sum" (Q.sum (Q.toQ xs)) (sum xs)
  where
    xs :: [Integer]
    xs = [-1, -4, -5, 2]

hnegative_map_sum :: (Backend b, VectorLang v) => DSHAssertion v b
...
prop_nub_length :: (Backend b, VectorLang v) => [Integer] -> DSHProperty v b
prop_nub_length = makePropEq (Q.length . Q.nub) (fromIntegral . length . nub)

prop_map_nub_length :: (Backend b, VectorLang v) => [[Integer]] -> DSHProperty v b
prop_map_nub_length = makePropEq (Q.map (Q.length . Q.nub)) (map (fromIntegral . length . nub))

prop_elem_sort :: (Backend b, VectorLang v) => ([Integer], [(Integer, Char)]) -> DSHProperty v b
...
prop_elem_sort2 :: (Backend b, VectorLang v) => ([Integer], [(Integer, Char)]) -> DSHProperty v b
