...
type VSLRewrite p = Rewrite VSL (Shape DVec) p
type VSLRule p = Rule VSL p (Shape DVec)
type VSLRuleSet p = RuleSet VSL p (Shape DVec)
type VSLMatch p = Match VSL p (Shape DVec)
