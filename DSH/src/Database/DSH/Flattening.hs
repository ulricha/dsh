...
module Database.DSH.Flattening (fromQ, debugPlan, debugSQL, debugNKL, debugFKL, fromX100, debugX100, debugX100Plan, debugNKLX100, debugFKLX100, debugVL, debugVLJSON) where
...
debugVL :: (QA a, IConnection conn) => conn -> Q a -> IO String
debugVL c (Q e) = liftM nkl2VDot $ toNKL (getTableInfo c) e
